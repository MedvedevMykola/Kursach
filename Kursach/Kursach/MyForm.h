...
namespace Kursach {
	...
	private: System::Windows::Forms::ToolStripMenuItem^  заДатоюToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^  заДедлайномToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->заНазвоюToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->заДатоюToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->заДедлайномToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			this->Sorting->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->заНазвоюToolStripMenuItem,
					this->заДатоюToolStripMenuItem, this->заДедлайномToolStripMenuItem
			});
			...
			// 
			this->заНазвоюToolStripMenuItem->Name = L"заНазвоюToolStripMenuItem";
			this->заНазвоюToolStripMenuItem->Size = System::Drawing::Size(153, 22);
			this->заНазвоюToolStripMenuItem->Text = L"За Назвою";
			// 
			// заДатоюToolStripMenuItem
			// 
			this->заДатоюToolStripMenuItem->Name = L"заДатоюToolStripMenuItem";
			this->заДатоюToolStripMenuItem->Size = System::Drawing::Size(153, 22);
			this->заДатоюToolStripMenuItem->Text = L"За Датою";
			// 
			// заДедлайномToolStripMenuItem
			// 
			this->заДедлайномToolStripMenuItem->Name = L"заДедлайномToolStripMenuItem";
			this->заДедлайномToolStripMenuItem->Size = System::Drawing::Size(153, 22);
			this->заДедлайномToolStripMenuItem->Text = L"За Дедлайном";
			// 
			// NameList
			// 
